        ...
        >
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Analyse IA des images</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <h3 className="font-semibold text-gray-900">Analyse terminée</h3>
                ...
                <div className="space-y-4">
                  {analysisResult.name && (
                    <div className="space-y-2">
                      ...
                      <div className="p-3 bg-gray-50 rounded-lg border">
                        <span className="text-gray-900">{analysisResult.name}</span>
                      </div>
                    </div>
                  )}
                  ...
                  {analysisResult.description && (
                    <div className="space-y-2">
                      ...
                      <div className="p-3 bg-gray-50 rounded-lg border">
                        <span className="text-gray-900">{analysisResult.description}</span>
                      </div>
                    </div>
                  )}
                  ...
                  {analysisResult.shortDescription && (
                    <div className="space-y-2">
                      ...
                      <div className="p-3 bg-gray-50 rounded-lg border">
                        <span className="text-gray-900">{analysisResult.shortDescription}</span>
                      </div>
                    </div>
                  )}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {analysisResult.category && (
                      <div className="space-y-2">
                        ...
                        <div className="p-3 bg-gray-50 rounded-lg border">
                          <span className="text-gray-900 capitalize">{analysisResult.category}</span>
                        </div>
                      </div>
                    )}
                    ...
                    {analysisResult.brand && (
                      <div className="space-y-2">
                        ...
                        <div className="p-3 bg-gray-50 rounded-lg border">
                          <span className="text-gray-900">{analysisResult.brand}</span>
                        </div>
                      </div>
                    )}
                  </div>
                  ...
                  {analysisResult.price && (
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700">Prix estimé</label>
                      <div className="p-3 bg-gray-50 rounded-lg border">
                        <span className="text-gray-900">{analysisResult.price} €</span>
                      </div>
                    </div>
                  )}
                  ...
                  {analysisResult.tags && analysisResult.tags.length > 0 && (
                    <div className="space-y-2">
                      <label className="text-sm font-semibold text-gray-700">Tags suggérés</label>
                ...
                <div className="flex space-x-3 pt-4 border-t border-gray-200">
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r from-purple-500 to-pink-500 text-white py-3 px-4 rounded-xl font-semibold hover:shadow-lg transition-all"
                  >
