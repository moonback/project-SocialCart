...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-primary-100 to-surface-50 flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary-200/20 rounded-full blur-3xl translate-y-48 -translate-x-48 animate-float" style={{ animationDelay: '1s' }} />
